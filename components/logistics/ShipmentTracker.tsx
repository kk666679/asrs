...
import FleetLocationMap from '@/components/maps/FleetLocationMap';
        ...
        {trackingData && (
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <FleetLocationMap
                center={{ lat: 37.7749 + Math.random() * 0.01, lng: -122.4194 + Math.random() * 0.01 }}
                zoom={12}
                height="200px"
                points={[{
                  id: trackingData.shipment.shipmentNumber,
                  name: trackingData.shipment.shipmentNumber,
