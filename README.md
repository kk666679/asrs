...
![TailwindCSS](https://img.shields.io/badge/TailwindCSS-4.3.3-38B2AC?logo=tailwindcss)
![NestJS](https://img.shields.io/badge/NestJS-11.1.28-E0234E?logo=nestjs)
...
| Layer               | Technology                                              |
| ------------------- | ------------------------------------------------------- |
| **Frontend**        | Next.js 16.3.0, React 19.2.8, TypeScript 7.0.2, TailwindCSS 4.3.3 |
| **State Management** | Zustand 5.0.8, TanStack Query 5.90.5, WebSocket Real-time |
| **Backend**         | NestJS 11.1.28, Prisma ORM 7.9.1, SQLite Database     |
...
```bash
# 1. Clone repository
git clone https://github.com/akutuah/asrs.git
cd asrs
...
## 🧪 Hermes CLI Package
This repository includes a local Hermes CLI package at `.hermes/custom`. Use the local wrapper to inspect Hermes commands and refresh package dependencies:
...
This package provides a command scaffold for Hermes behavior; a full Hermes runtime is required to enable conversation, session resume, and AI features.
...
# Use backend scripts in backend/ for linting and tests
